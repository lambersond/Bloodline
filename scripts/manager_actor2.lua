...
function getAbilityScore(rActor, sAbility)
	...
	elseif sShort == "blo" then
		nStatScore = DB.getValue(nodeActor, "abilities.bloodline.score", 0);
	elseif sShort == "hon" then
		nStatScore = DB.getValue(nodeActor, "abilities.honor.score", 0);
