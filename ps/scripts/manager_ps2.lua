...
function linkPCFields(nodePS)
	...
	PartyManager.linkRecordField(nodeChar, nodePS, "abilities.bloodline.score", "number", "bloodline");
	...
	PartyManager.linkRecordField(nodeChar, nodePS, "abilities.bloodline.bonus", "number", "blobonus");
